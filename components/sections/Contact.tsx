...
export const Contact: React.FC<SectionProps> = ({ x }) => {
  ...
  return (
    <section className="w-full h-full flex flex-col items-center justify-center bg-transparent text-black relative overflow-hidden px-4 md:px-0">
      ...
      <AnimatePresence mode="wait">
        {formStatus === 'success' ? (
            ...
            <motion.div 
                key="form-container"
                className="z-20 w-full max-w-md md:max-w-xl min-h-[500px] flex flex-col items-center justify-center bg-white/70 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-black/10"
