      ...
      <div className="flex-1 flex items-center md:items-end pb-20 md:pb-32">
        <div className="max-w-[90vw] md:max-w-[80vw] z-10">
          <motion.h1 
            ...
            className="font-display text-[10vw] md:text-[5rem] lg:text-[7rem] leading-[0.9] text-black font-medium tracking-tight"
          >
            Independent <br />
            {/* Accent Orange Creative */}
            <span className="ml-[5vw] md:ml-[8vw] block font-normal text-accent">Creative</span>
            <span className="block text-right mr-[5vw]">Design Studio</span>
          </motion.h1>
        </div>
      </div>
